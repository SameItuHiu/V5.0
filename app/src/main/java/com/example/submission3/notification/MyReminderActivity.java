    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        dailyReminder.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                if (isChecked) {
                    myReminder.setDailyReminder(MyReminderActivity.this,MyReminder.DAILY_REMINDER);
        ...
        newReleaseReminder.setOnCheckedChangeListener(new CompoundButton.OnCheckedChangeListener() {
            ...
            public void onCheckedChanged(CompoundButton compoundButton, boolean isChecked) {
                if (isChecked) {
                    myReminder.setNewRelaseReminder(MyReminderActivity.this, MyReminder.NEW_RELEASE_REMINDER);
